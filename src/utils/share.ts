import type { Caption, CaptionSize, MapStyle, Pin, PinDotShape, PinDotSize, PrintArea, PrintOrientation, PrintPaperSize, Route, RouteLineStyle, RouteWaypointSize, RouteWaypointStyle } from '@/types'
