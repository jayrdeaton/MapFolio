...
export function useMapContextMenu({ leafletMap, hasClipboard, onPlacePinSingle, onPlacePinMultiple, onStartRoute, onPlaceCaption, onPaste, onDownloadPdf, onRemovePrintArea }: UseMapContextMenuOptions) {
    ...
    ctxPopup = L.popup()
      ...
      .setContent(
        `<div class="pin-popup" style="padding:4px 0;min-width:150px;">
          ...
          <button class="pin-popup-action-row pin-popup-delete print-ctx-delete">${PRINT_DELETE_SVG} Delete Print Area</button>
        </div>`
      )
      .openOn(map)
